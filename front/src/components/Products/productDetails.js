            ...
            <div className='row d-flex justify-content-around'>
                <div className='col-12 col-lg-5 img-fluid' id="imagen_producto">
                    <Carousel pause='hover'>
                        {product.imagen && product.map(img =>(
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div className='rating-outer'>
                                ...
                                <samp id="No_de_reviews">    ({product.numCalificaciones} Reviews)</samp>
                                <hr/>
                                <p id='precio_producto'>${product.precio}</p>
                                <div className='stockCounter d_inline'>
                                    <span className='btn btn-danger minus' onClick={decreaseQty}>-</span>
                                    <input type="number" className="form-comtrol count d-inline" value={quantity} readOnly />
                                    <span className='btn btn-danger plus' onClick={increaseQty}>+</span>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                        <h5 class="card-title" className='mt-2'>Descripción:</h5>
                        ...
                        <hr/>
                        <p>Estado: <samp id='stock_stado' className={product.inventario>0 ? 'greennColor':'redColor'}>{product.inventario>0 ? 'En exixtencia':'Agotado'}</samp></p>
                        <button id="btn_review" type='button' className='btn btn-primary mt-4' data-toggle="modal" data-targer='#calificacionModal'>Deja tu Opinion</button>
